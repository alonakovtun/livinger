...
/**
 * Returns available woocommerce for each post type.
 *
 * @date	29/8/17
 * @since	5.6.2
 *
...
function acf_get_post_templates() {
	...
	// Initialize woocommerce with default placeholder for pages.
	$post_templates = array();
	$post_templates['page'] = array();
	
	// Loop over post types and append their woocommerce.
