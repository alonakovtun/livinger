    ...
    function openProductHandler() {
      ...
      pauseButtons.forEach((pauseButton) => {
        pauseButton.addEventListener('click', (e) => {
          e.preventDefault();
          const videoElem = pauseButton.parentNode.parentNode.nextElementSibling.querySelector(
            'video'
          );
      ...
      closeButtons.forEach((closeButton) => {
        closeButton.addEventListener('click', function (e) {
          ...
          const videoElem = closeButton.parentNode.nextElementSibling.querySelector(
            'video'
          );
