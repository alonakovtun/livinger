...
class Przelewy24Generator
{
    ...
    public function generate_fields_array($order_id, $transaction_id = null)
    {
        ...
        $przelewy24_arg = array(
            ...
            'p24_url_return' => filter_var($this->gateway->getReturnUrl($order), FILTER_SANITIZE_URL),
            'p24_api_version' => P24_VERSION,
            'p24_ecommerce' => 'woocommerce_' . WOOCOMMERCE_VERSION,
            'p24_ecommerce2' => '1.0.13',
            'p24_method' => (int)get_post_meta($order->get_id(), 'p24_method', true),
     ...
     * @return array
     */
    public function generate_payload_for_rest( $order_id ) {
        $args = $this->generate_fields_array( $order_id );
...
FORMRECURING;
    ...
    {
        $hasP24NowSelected = 266 === $przelewy24_arg['p24_method'];
