    ...
    if (sizeof($parent_terms) > 0) {
      ...
      foreach ($parent_terms as $parent_term) {
        ...
        if ($count > 0 || $force_show === true) {
          ...
          $html .= '<a href="javascript:void(0)" data-key="' . $data_key . '" data-value="' . $parent_term_id . '" data-multiple-filter="' . $enable_multiple . '">' . $parent_term->name . '<svg class="filter_active" id="SVGDoc1" width="13" height="10" xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:avocode="https://avocode.com/" viewBox="0 0 13 10"><g><g><image xlink:href="data:image/png;base64," width="13" height="10" transform="matrix(1,0,0,1,0,0)" ></image></g></g></svg></a>';
