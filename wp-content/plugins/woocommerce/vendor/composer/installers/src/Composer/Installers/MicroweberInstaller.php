...
class MicroweberInstaller extends BaseInstaller
{
    protected $locations = array(
        ...
        'module-skin' => 'userfiles/modules/{$install_item_dir}/woocommerce/',
        'template' => 'userfiles/woocommerce/{$install_item_dir}/',
    ...
    public function inflectPackageVars($vars)
    {
        ...
        if ($this->package->getTargetDir()) {
            ...
            if ($vars['type'] === 'microweber-woocommerce') {
    ...
    {
        $vars['install_item_dir'] = preg_replace('/-woocommerce$/', '', $vars['install_item_dir']);
        $vars['install_item_dir'] = preg_replace('/woocommerce-$/', '', $vars['install_item_dir']);
