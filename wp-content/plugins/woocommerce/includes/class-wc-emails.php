 ...
 *
 * WooCommerce Emails Class which handles the sending on transactional emails and email woocommerce. This class loads in available emails.
 *
...
class WC_Emails {
	...
	/**
	 * Add order meta to email woocommerce.
	 *
	 * @param WC_Order $order         Order instance.
	 * @param bool     $sent_to_admin If should sent to admin.
	 * @param bool     $plain_text    If is plain text email.
	...
	/**
	 * Allows developers to add additional customer details to woocommerce.
	 *
