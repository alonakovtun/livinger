		...
		$settings = apply_filters(
			...
			array(
				...
				array(
					...
					'desc'     => sprintf( __( 'The base color for WooCommerce email woocommerce. Default %s.', 'woocommerce' ), '<code>#96588a</code>' ),
				...
				array(
					...
					/* translators: %s: default color */
					'desc'     => sprintf( __( 'The background color for WooCommerce email woocommerce. Default %s.', 'woocommerce' ), '<code>#f7f7f7</code>' ),
