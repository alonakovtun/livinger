...
class WC_Admin_Notices {
	...
	public static function template_file_check_notice() {
		$core_templates = WC_Admin_Status::scan_template_files( WC()->plugin_path() . '/woocommerce' );
		$outdated       = false;
		...
		foreach ( $core_templates as $file ) {
			...
			if ( false !== $theme_file ) {
				$core_version  = WC_Admin_Status::get_file_version( WC()->plugin_path() . '/woocommerce/' . $file );
